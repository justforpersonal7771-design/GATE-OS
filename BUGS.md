...
- [ ] **AI-generated practice questions are low quality and mis-tagged** — not discrete/well-formed, not generated specifically around the selected subject/topic, answers not appropriate. This is the single most important AI-quality bug per the user. *(AI Generated #2, restated as critical at the end)*
- [ ] **AI Generated test throws an error on start**, and the timer is wrong for that mode. *(AI Generated #4)*
