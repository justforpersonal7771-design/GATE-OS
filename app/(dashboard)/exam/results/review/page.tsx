                        ...
                        <div className="w-full">
                          ...
                          {q.question_type === "NAT" && (
                            <div className="flex flex-col sm:flex-row gap-4 p-4 bg-[var(--surface)] border border-[var(--border)] rounded-2xl w-full">
                               ...
                               <div className={`flex-1 flex justify-between items-center bg-[var(--surface-secondary)] p-3 border rounded-xl ${
                                 isAttempted 
                                   ? (isCorrect 
                     ...
                     {draftQuestions.map((qRef, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`aspect-square w-full rounded-lg flex items-center justify-center font-bold text-sm transition-all border focus:outline-none cursor-pointer ${colorClass} ${
                              isCurrent
